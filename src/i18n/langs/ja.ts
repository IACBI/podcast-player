...
const ja: Lang = {
  ...
  proxies_disabled_err: "Seseriバックエンドに接続できず、外部プロキシは無効です。設定 → プライバシーで有効にするか、しばらく後にお試しください。",
  s_privacy: "プライバシー",
  ...
  sleep_set_episode: "スリープ: エピソードの終わり",
  sleep_off: "スリープタイマー オフ",
  sleep_extended: "スリープ: +5 分",
  ...
  sc_close: "プレーヤーを閉じる",
  sc_help: "この一覧を表示",
  s_ambient: "アートワークから配色",
  s_ambient_hint: "再生中の背景をカバーアートの色で着色します",
  np_notes: "エピソードノート",
  ...
  dl_opened_tab: "オフライン保存に失敗 — 新しいタブで開きました",
