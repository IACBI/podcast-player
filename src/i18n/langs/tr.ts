...
const tr: Lang = {
  ...
  private_feed_err: "Bu akış özel bir erişim anahtarı taşıyor; bu yüzden herkese açık vekil sunuculara gönderilmiyor. Yüklemek için kendi sunucunuzu yapılandırın.",
  ...
  s_ambient_hint: "Şimdi çalıyor arka planını kapak görselinden renklendir",
  ...
  dl_opened_tab: "Çevrimdışı kayıt olmadı — yeni sekmede açıldı",
