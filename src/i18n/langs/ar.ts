...
const ar: Lang = {
  ...
  private_feed_err: "تحتوي هذه التغذية على رمز وصول خاص، لذلك لا تُرسل إلى الوسطاء العامّين. اضبط خادمك الخاص لتحميلها.",
  proxies_disabled_err: "تعذر الوصول إلى خادم Seseri، والوكلاء الخارجيون معطّلون. فعّلهم من الإعدادات ← الخصوصية، أو أعد المحاولة لاحقًا.",
  s_privacy: "الخصوصية",
  s_allow_proxies: "السماح بالوكلاء الخارجيين",
  s_allow_proxies_sub: "مسار بديل عند تعذر الوصول إلى خادم Seseri. يرى هؤلاء المشغّلون عنوان كل تغذية تفتحها ويمكنهم تغيير ما يعيدونه.",
  dur_h: "س",
  dur_m: "د",
  ...
  limit_note: "تعذر تحميل الحلقات الأقدم",
  ...
  btn_json_import: "استعادة نسخة JSON",
  ...
  dl_opened_tab: "تعذر الحفظ دون اتصال — فُتح في تبويب جديد",
