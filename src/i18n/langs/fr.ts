...
const fr: Lang = {
  ...
  proxies_disabled_err: "Le backend Seseri est injoignable et les proxys tiers sont désactivés. Activez-les dans Réglages → Confidentialité, ou réessayez plus tard.",
  ...
  sleep_set_episode: "Minuteur : fin de l'épisode",
  sleep_off: "Minuteur désactivé",
  sleep_extended: "Minuteur : +5 min",
  sleep_remaining: "Temps restant du minuteur",
  ...
  s_ambient_hint: "Teinter le fond du lecteur à partir de la pochette",
  ...
  dl_opened_tab: "Échec hors ligne — ouvert dans un nouvel onglet",
